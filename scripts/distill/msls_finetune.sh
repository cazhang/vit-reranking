...
CUDA_VISIBLE_DEVICES=1,2 python train_msls_KDembed_tri.py --dataset $dataset --kernels 8 --source_path $datapath --n_epochs 10 --group mini_MSLS_CVT512_vlad512_embed1_1e-4 --loss_margin_beta 0.6 --seed 0 --bs 6 --pool patchnetvlad \
						--samples_per_class 2 --loss margin --batch_mining distance \
						--arch cvt_13_normalize --embed_dim 512 --num_clusters 16 \
						--vlad_ckpt /home/czhang/Pretrained_models/Netvlad/mapillary_WPCA512.pth.tar \
						--append_pca_layer --num_pcs 512 --save_path Training_Results \
						--imageresizew 224 --imageresizeh 224 --optim adam --lr 0.0001 --cachebatchsize 20 \
						--evalevery 1 --task_loss triplet \
						--distill embed --kd_weight 1.0 --tl_weight 0.0 --mini_data
						
# distill cvt from vlad (embed + supcon)			
# CUDA_VISIBLE_DEVICES=2 python train_msls_KDembed_tri.py --dataset $dataset --kernels 8 --source_path $datapath --n_epochs 30 --group mini_MSLS_CVT_supcon+KD10_1e-4 --loss_margin_beta 0.6 --seed 0 --bs 3 --pool patchnetvlad \
						# --samples_per_class 2 --loss margin --batch_mining distance \
						# --arch cvt_13_normalize --embed_dim 128 --num_clusters 16 \
						# --vlad_ckpt /home/czhang/Pretrained_models/Netvlad/mapillary_WPCA128.pth.tar \
						# --append_pca_layer --num_pcs 128 --save_path Training_Results \
						# --imageresizew 224 --imageresizeh 224 --optim adam --lr 0.0001 --cachebatchsize 20 \
						# --evalevery 1 --task_loss supcon \
						# --distill embed --kd_weight 10.0 --mini_data
