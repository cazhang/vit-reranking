...
for method, info in LOGS.items():
	...
	if MODE_DEBUG:  # finetuned version
		result = evaluate(model, datasets['testing'], dataloaders['testing'], opt.training, trunc_nums=trunc_nums, use_uniform=opt.use_uniform, grid_size=opt.grid_size, to_submit=opt.to_submit)
