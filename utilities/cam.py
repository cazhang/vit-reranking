...
def get_args():
    ...
    parser.add_argument(
        '--image-path',
        type=str,
        default='/home/czhang/DIML/samples/Red_Faced_Cormorant_0024_796285.jpg',
...
def get_cam_ouput(model, input_tensor, cam_method, use_cuda=False):
...
def demo():
    ...
    rgb_img = cv2.imread('/home/czhang/DIML/samples/Red_Faced_Cormorant_0024_796285.jpg', 1)[:, :, ::-1]
